...
test-py:  ## run python tests
	python -m pytest -v verilator/tests --junitxml=junit.xml

coverage-py:  ## run tests and collect test coverage
	python -m pytest -v verilator/tests --junitxml=junit.xml --cov=verilator --cov-report=xml:.coverage/coverage.xml --cov-report=html:.coverage/coverage.html --cov-branch --cov-fail-under=80 --cov-report term-missing
